...
// The live URL for your backend server on Render
const PROD_URL = 'https://live-restaurant-menu-api.onrender.com/api';

// Create an Axios instance with the base URL for authenticated requests
